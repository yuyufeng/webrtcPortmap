...
echo [1/2] Building signaling server (with Web UI)...
...
echo [2/2] Building agent (with port configuration)...
...
echo   2. Start agent:      .\%BUILD_DIR%\agent.exe -id myagent -password mypass
echo   3. Web UI:           http://localhost:8443/
echo.
